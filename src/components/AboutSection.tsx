        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg hidden md:block">
              <p className="text-loveable-gold font-bold text-2xl">5+ années</p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                <p className="text-3xl font-bold text-loveable-gold">1000+</p>
                <p className="text-loveable-brown">Clients satisfaits</p>
              </div>
              <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                <p className="text-3xl font-bold text-loveable-gold">50+</p>
                <p className="text-loveable-brown">Styles de tresses</p>
              </div>
            </div>
          </div>
        </div>
